...
package com.seenmovies.actionbarcompat;
...
public class ActionBarHelperBase extends ActionBarHelper {
	...
	public static final int HOME_ITEM = 19;
    ...
    private void setupActionBar() {
        ...
        SimpleMenuItem homeItem = new SimpleMenuItem(
                tempMenu, HOME_ITEM, 0, mActivity.getString(R.string.app_name));
        homeItem.setIcon(R.drawable.seenmovies_icon);
